 ...
 * @author Ville
 * 
 * <p>Luokka hallitsee summauspalvelimia ja yll‰pit‰‰ yhteytt‰ palvelimen Y kanssa.</p>
 */
public class SumServerHandler implements Runnable, Observer {
	...
	/**
	 * <p>Metodi hallitsee palvelimelta Y tulevat pyynnˆt.</p>
	 * @throws IOException
	 */
	...
	/**
	 * 	<p>L‰hett‰‰ summauspalvelinten portti numerot palvelimelle Y.</p>
